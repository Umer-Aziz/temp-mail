...
const Navbar = () => {
  return (
    ...
    <nav className='border-md-bottom'>
      ...
      <p className="mt-2 h4 text-center font-boo temp-mail" style={{cursor:"pointer"}}><MdOutlineAlternateEmail className="mail-logo text-danger"/>TEMP<span className="text-danger border border-2 border-danger">MAIL</span></p>
    <div>
